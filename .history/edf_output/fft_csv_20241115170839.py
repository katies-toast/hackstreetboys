...
file_path = "/Users/nathanc/Desktop/python_sketch/nathacks_2024/shared_github/hackstreetboys/edf_output/filtered_psg_data.csv"  # Replace with your CSV file path

def FFT(file_path):
    data = pd.read_csv(file_path)

    # Extract the column of interest 
    signal = data['EEG Fpz-Cz'].values  # Replace 'signal' with the column name in your CSV
...
positive_frequencies, positive_magnitude = FFT(file_path)
print(positive_frequencies, positive_magnitude)
